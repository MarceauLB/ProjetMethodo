...
from HSICLassoVI.features.make_kernel import make_kernel, compute_kernel
from HSICLassoVI.features.make_kernel_for_NOCCO import make_kernel_for_NOCCO, compute_kernel_for_NOCCO
